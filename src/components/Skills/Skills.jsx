      ...
      <div className="main">
        ...
        <div className="skills-container">
          <div className="skills-container-items skill1">
            <img className="skills-image" src={html} alt="logo"></img>
          </div>
          <div className="skills-container-items skill2">
            <img className="skills-image" src={css} alt="logo"></img>
          </div>
          <div className="skills-container-items skill4">
            <img className="skills-image" src={js} alt="logo"></img>
          </div>
          ...
          <div className="skills-container-items skill4">
            <img className="skills-image" src={db} alt="logo"></img>
          </div>
        </div>
        <br></br>
        <br></br>
